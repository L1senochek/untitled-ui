...
import styles from './icon-mobile-google-play.module.scss';

const IconMobileGooglePlay: React.FC = (): JSX.Element => {
  return (
    <svg
      width="135"
      height="40"
    ...
    >
      ...
      <rect
        ...
        rx="4.5"
        stroke="#A6A6A6"
        className={styles.googleplay__border}
      />
      <path
      ...
      <path
        ...
        strokeMiterlimit="10"
      />
      <g filter="url(#filter0_ii_1509_257223)">
        <path
          d="M10.4361 7.53784C10.1451 7.84584 9.97314 8.32384 9.97314 8.94284V31.0588C9.97314 31.6788 10.1451 32.1558 10.4361 32.4638L10.5101 32.5358L22.8991 20.1468V20.0008V19.8548L10.5101 7.46484L10.4361 7.53784Z"
          fill="url(#paint0_linear_1509_257223)"
        />
        <path
          d="M27.0279 24.2779L22.8989 20.1469V20.0009V19.8549L27.0289 15.7249L27.1219 15.7779L32.0149 18.5579C33.4119 19.3519 33.4119 20.6509 32.0149 21.4459L27.1219 24.2259L27.0279 24.2779Z"
          fill="url(#paint1_linear_1509_257223)"
        />
        <g filter="url(#filter1_i_1509_257223)">
          <path
            d="M27.122 24.225L22.898 20.001L10.436 32.464C10.896 32.952 11.657 33.012 12.514 32.526L27.122 24.225Z"
            fill="url(#paint2_linear_1509_257223)"
          />
        </g>
        <path
          d="M27.122 15.7769L12.514 7.47694C11.657 6.98994 10.896 7.05094 10.436 7.53894L22.899 20.0019L27.122 15.7769Z"
          fill="url(#paint3_linear_1509_257223)"
        />
      </g>
      <defs>
        <filter
          id="filter0_ii_1509_257223"
          x="9.97314"
          y="7.14087"
          width="23.0894"
          height="25.7207"
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect1_innerShadow_1509_257223"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_innerShadow_1509_257223"
            result="effect2_innerShadow_1509_257223"
          />
        </filter>
        <filter
          id="filter1_i_1509_257223"
          x="10.436"
          y="20.001"
          width="16.686"
          height="12.8606"
...
export default IconMobileGooglePlay;
